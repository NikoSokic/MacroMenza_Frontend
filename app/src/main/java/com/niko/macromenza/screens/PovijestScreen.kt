                ...
                item {
                    Card(modifier = Modifier.fillMaxWidth()) {
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            val daniUTjednu = listOf("Pon", "Uto", "Sri", "Čet", "Pet", "Sub", "Ned")
                            val maxKalorije = pregled.dani.maxOfOrNull { it.kalorije } ?: 1.0
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(
                                text = if (najboljiDan != null)
                                    "${najboljiDan.datum} – %.0f kcal".format(najboljiDan.kalorije)
                                else
                                    "Nema podataka"
                            )
                            ...
                            Text(
                                text = if (najviseProteina != null)
                                    "${najviseProteina.datum} – %.0f g".format(najviseProteina.proteini)
                                else
                                    "Nema podataka"
                            )
                        }
